...
export default class AppFooter extends React.PureComponent<AppFooterProps, AppFooterState> {
    ...
    render(): ReactNode {
        return (
            <Container
                className="AppFooter"
                id={this.baseContainerId}
                sx={{ boxShadow: 5, position: 'fixed', bottom: 0, minWidth: '100%', zIndex: 1250 }}
                disableGutters={true}
                fixed={true}
                maxWidth={false}
            >
